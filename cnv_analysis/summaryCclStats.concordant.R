...
#load("~/Onedrive/bhk_lab/results/snp_fingerprinting/allSnps/subHeatmap.May24-2017.Rdata")

#save(anno.mismatch.m.filt.df, file="~/git/CellLineConcordance/snp_analysis/data/anno_mm.Rdata")
anno.dir <- '~/git/CellLineConcordance/snp_analysis/data'
outdir <- '~/Desktop'

outdir <- '/results/snp'  #codeocean
anno.dir <- '/data/snp' #codeocean
load(file.path(anno.dir, "anno_mm.Rdata"))
...
### -------------------- Visualization
pdf(file.path(outdir, "annoCclConc.pdf"))
