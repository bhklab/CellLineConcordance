...
attributes(abc.matrices)$colnames <- 'gCSI'
attributes(abc.matrices)$rownames <- 'CCLE'
save(abc.matrices, file="/mnt/work1/users/bhklab/Projects/cell_line_clonality/total_cel_list/datasets/abc/gcsi-ccle-abc/abc.gcsi-ccle.Rdata")
